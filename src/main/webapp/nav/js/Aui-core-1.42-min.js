(function (e, c) {
    var g = e.document, h = e.location, i = e.navigator, m = Array.prototype.push, f = Array.prototype.slice, l = Array.prototype.indexOf, d = Array.prototype.concat, k = Object.prototype.toString, b = Object.prototype.hasOwnProperty, j = function (o, n) {
    ...
    j.fn = {
        ...
        selector: function (o, r) {
            ...
            if (j.isString(o)) {
                var n = this, p = this.Aui_RegExp, s = o.split(","), t = function (v, u) {
                    return v.test(u) ? v.exec(u)[0] : ""
                };
                fnSelect = function (y, x, w) {
                    var v = [], z = /[#\.]{1}/g.exec(y), u = t(w.TAG, y);
                    switch (z && z[0]) {
                        case"#":
                    ...
                    var w = /\[(.+?)\]/g.test(z) ? z.match(/\[(.+?)\]/g) : "", u = [];
                    if (w) {
                        j.each(v, function () {
                            var E = this, B = w.length - 1, A = true;
                            while (B >= 0) {
                                var D = w[B] ? w[B].match(/[^\[\]=\'\"\s]+/g) : "", C = D.length;
                                if (C === 1) {
                    ...
                    return u.length ? u : v;
                    var y = w ? w.match(/[^\[\]=\'\"\s]+/g) : "", x = y.length;
                    j.each(v, function () {
                    ...
                    var x = v.substring(1), u = this.makeArray(u), w = /\d+/.test(x) ? parseInt(/\d+/.exec(x)[0], 10) : 0;
                    result = [];
                    ...
                    var w = x.match(/\S+(\[.+?\](\[.+?\])*)|\S+/g), u = w.length - 1, v = [];
                    while (u >= 0) {
                ...
                j.each(s, function (w, u) {
                    var u = /\[.+?\]/g.test(u) ? handleStr(u) : u, x = x || r;
        ...
        color10: function (t) {
            var v = /^#{1}[0-9|a-f]{6}$/ig, n = /^#{1}[0-9|a-f]{3}$/ig, s = /((GB|rgb)\()|(\))/g, p = function (y, z, x) {
                return parseInt(y.toString().substring(z, x), 16)
            }, w = function (x) {
                return parseInt(x, 10)
            };
            if (n.test(t)) {
                var t = t.substring(1), q = t.slice(0, 1), u = t.slice(1, 2), o = t.slice(2, 3);
        ...
        getSize: function (r, v, q, s, p) {
            ...
            switch (u) {
                case g:
                    var t = u.documentElement["scroll" + v], n = u.documentElement["client" + v];
                    return (t > n ? t : n) + p;
                    break;
                case e:
        ...
        getElement: function (r, q, p, s) {
            var o = this, n = [], p = p || "*", q = q instanceof Array ? q : q.length ? this.makeArray(q) : [q];
            j.each(q, function () {
                if (s === "id") {
                    j.each(this.getElementsByTagName(p), function () {
        ...
        animation: function (t, z, r, x, v) {
            var v = j.easing[(typeof v === "string" ? v : "easeDefault") || "easeDefault"], r = r * 0.1 || 40, s = this, y = 0, u = t, p = u.style, o = p.length > 0 || p.length === c, n = /(^#{1})|[rgb|RGB]{3}/, q = (function (E, D, C) {
                var F = {}, A;
                for (A in D) {
                    var B = n.test(D[A]);
    ...
    j.fn.init.prototype = {
        _Aui: j.fn, constructor: "Aui", splice: [].splice, concat: [].concat, slice: function () {
            return this._Aui.toAui(this._Aui.toArray(this, arguments))
        }, push: m, objToString: k, objHasOwn: b, eq: function (n) {
            ...
            var n = this, p = n._Aui.toArray, q = o ? p(n, 0) : (function (t, u) {
                var s = [];
                j.each(t, function () {
                    this.tagName === u && s.push(this)
                });
                return s
            })(n[0].parentNode.children, n[0].tagName), r = o ? o[0] || o : n[0];
            return (function (s, v) {
                if (l) {
                    return l.call(s, v)
                } else {
            ...
            var o = this._Aui.getOffset, p = this[0];
            ...
            if (j.isString(n)) {
                j.each(this, function () {
                    var o = this.className, p = RegExp(n, "ig");
                    if (o) {
                        if (!p.test(o)) {
                            this.className += " " + n
                        }
            ...
            if (j.isString(p)) {
                var o = RegExp("(s{1}\b" + p + "\b)|(\b" + p + "\bs{1})", "ig"), n = this.className;
                j.each(this, function () {
                    if (n) {
            ...
            j.each(this, function (r, q) {
                ...
                if (!s._handler_) {
                    s._handler_ = function (y) {
                        var t = y || e.event, u = t.type, z = function (C, D, E) {
                            for (var A = 0, B; B = C[A++];) {
                                if (false === B.call(E, D)) {
                        ...
                        if (u === "mouseover" || u === "mouseout") {
                            var v = u === "mouseover" ? t.fromElement : t.toElement, x = t.currentTarget, w = t.relatedTarget || v;
            ...
            var o = this, r = o[0], q = r.parentNode, n = r.nextSibling;
            while (n.nodeType !== 1) {
                n = n.nextSibling
            }
            ...
            var n = this, q = n[0], p = q.parentNode;
            this._Aui.insertNode(o, n, q, p);
            return n
        }, append: function (o) {
            var n = this, p = n[0].children, q = p[p.length];
            this._Aui.insertNode(o, n, q, n[0]);
            return n
        }, prepend: function (o) {
            var n = this, p = n[0].children[0];
            this._Aui.insertNode(o, n, p, n[0]);
            return n
        }, next: function () {
            var o = this[0], n = o.nextSibling;
            while (n.nodeType !== 1) {
                n = n.nextSibling
            }
            return this._Aui.toAui([n])
        }, prev: function () {
            var o = this[0], n = o.previousSibling;
            while (n.nodeType !== 1) {
                n = n.previousSibling
            }
            return this._Aui.toAui([n])
        }, siblings: function (q) {
            var o = this[0], p = o.parentNode.children, n = [];
            j.each(p, function () {
                if (q) {
    ...
    j.ajax = function (q) {
        ...
        var t = q.type.toLowerCase() || "get", o = q.url || "", r = q.data || null, p = q.code || "utf-8", u = q.error || c, v = q.beforeSend || c, w = q.success || c, x = j.makeString(r), n = /\?{1}/.test(o) ? r ? o.slice(0, o.search(/\?{1}/)) : o : o;
        if (t === "get") {
            x && (n += "?" + x);
            x = null
        }
    ...
    j.browser = function () {
        var o = i.userAgent.toLowerCase(), n = "";
    ...
    j.each = function (q, s) {
        var r = j.typeOf(q), o = j.isFunction(s), p;
    ...
    j.typeOf = function (p) {
        var s = {}, o, n = ["Boolean", "Number", "String", "Function", "Array", "Date", "RegExp", "Object"], r = n.length;
        for (o = 0; o < r; o += 1) {
